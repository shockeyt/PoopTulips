...
<div id="jas-content">
	...
	<?php if ( $vc == 'false' || empty( $vc ) || ( isset( $options['page-layout'] ) && $options['page-layout'] != 'no-sidebar' ) ) echo '<div class="jas-container">'; ?>
		<div class="jas-row jas-page">
			<div class="<?php echo esc_attr( $content_class ); ?>" role="main" <?php jas_gecko_schema_metadata( array( 'context' => 'entry' ) ); ?>>
				<?php
			...
			<?php if ( isset( $options['page-layout'] ) && $options['page-layout'] != 'no-sidebar' ) { ?>
				<div class="<?php echo esc_attr( $sidebar_class ); ?>" role="main">
					<?php
						echo '<div class="sidebar mt__60 mb__60" role="complementary" ' . jas_gecko_schema_metadata( array( 'context' => 'sidebar', 'echo' => false ) ) . '>';
