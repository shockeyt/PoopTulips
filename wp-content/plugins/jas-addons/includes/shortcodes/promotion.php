...
if ( ! function_exists( 'jas_shortcode_promotion' ) ) {
	function jas_shortcode_promotion( $atts, $content = null ) {
		$output = $image = '';
		...
		// Return output
		return apply_filters( 'jas_shortcode_promotion', force_balance_tags( $output ) );
	}
}